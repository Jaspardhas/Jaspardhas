document.addEventListener('DOMContentLoaded', function() {
  ...
  function showSlides() {
      ...
      slides.forEach((slide, index) => {
          if (index === slideIndex) {
              slide.querySelector('img').classList.remove('blackout-effect');
          } else {
              slide.querySelector('img').classList.add('blackout-effect');
          }
      });
  }
  ...
  // Automatically slide to next image every 1 second
